(() => {
  ...
  function c(e) {
    ...
    return i[e](t, t.exports, c), (t.loaded = !0), t.exports;
  }
  (c.m = i),
    (e =
    ...
    (c.a = (o, a, i) => {
      ...
      (f[r] = d),
        (f[e] = (e) => (s && e(s), p.forEach(e), f.catch((e) => {}))),
        (o.exports = f),
        a(
          (o) => {
            var a;
        ...
        if (void 0 !== t)
          for (
            ...
            if (
              ...
              p.getAttribute('data-webpack') == a + t
            ) {
              i = p;
              break;
            }
    ...
    (c.v = (e, r, t, n) => {
      ...
      return 'function' == typeof WebAssembly.instantiateStreaming
        ? WebAssembly.instantiateStreaming(o, n).then((r) =>
    ...
    (() => {
      ...
      var r = (r, t) => {
        ...
        t = (self.webpackChunkrustapp = self.webpackChunkrustapp || []);
      t.forEach(r.bind(null, 0)), (t.push = r.bind(null, t.push.bind(t)));
    })(),
    (async function () {
      let e = null;
      try {
        e = await c.e(235).then(c.bind(c, 235));
      } catch (e) {
        return void console.error(e);
      }
      console.log(e);
      const r = document.getElementById('upload'),
        t = new FileReader();
      (t.onloadend = () => {
        let r = t.result.replace(/^data:image\/(png|jpeg|jpg);base64,/, ''),
          n = e.grayscale(r);
        document.getElementById('new-img').setAttribute('src', n);
      }),
        r.addEventListener('change', () => {
          t.readAsDataURL(r.files[0]);
        });
    })();
})();
